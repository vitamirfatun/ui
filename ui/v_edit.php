...
include("config.php");
 if (isset($_GET['nis'])){
    ...
    $url = 'proses_edit.php';
    $id = $_GET['nis'];
    //buat query untuk diambil dari datebase
 ...
 <html>
   ...
   <label for = 'alamat'>Alamat: </label><br>
    <textarea name= "alamat" rows= "3"><?php if(isset($_GET['nis']))
...
<td>
    ...
    <input type ="text" name = "no_telepon" value ="<?php if(isset($_GET['nis']))
    { echo $siswa['no_telepon'];} ?>"/>
    </div>
    <div>
